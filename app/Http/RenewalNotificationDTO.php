...
{
    private $id, $partnerRole, $productId, $externalTxId, $pricepointId, $mcc, $mnc, $msisdn, $entryChannel, $text,
        $largeAccount, $userIdentifier, $userIdentifierType, $mnoDeliveryCode, $transactionUUID;
    private $tags;
